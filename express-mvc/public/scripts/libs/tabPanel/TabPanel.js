...
TabPanel.prototype = {
    ...
    */
    addTab: function (tabitem) {
        ...
        if ($('#' + tabitem.id).length > 0) {
            ...
            var wFix = tabitem.closable == false ? 0 : 10;
            if (tabitem.icon) {
                ...
                title.addClass('title').attr('title', tabitem.title);
                if (title.width() > (this.tabWidth - 19 - wFix)) {
                    title.width((this.tabWidth - 32 - wFix));
                    tab.append('<DIV>...</DIV>');
                }
            }
            ...
            tab.bind('click', function (position) {
                return function () {
                    ...
                    if (tabEntity.callbacks.click) tabEntity.callbacks.click.apply(null, [position]);
                };
            }(this.tabs.length - 1));
    ...
    */
    kill: function (position) {
        ...
        for (var i = 0; i < this.tabs.length; i++) {
            ...
            this.tabs[i].tab.bind('click', function (i) {
                return function () {
                    ...
                    if (tabEntity.callbacks.click) tabEntity.callbacks.click.apply(null, [i]);
                };
            }(i));
        ...
        //callback closed
        if (typeof (tab.closed) != "undefined")
            tab.closed(tab);
    },
