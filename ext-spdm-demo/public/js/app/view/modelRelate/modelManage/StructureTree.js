Ext.define('SPDM.view.modelRelate.modelManage.StructureTree', {
	...
	openAddNode: function(id) {
		var me = this,
			editWindow = Ext.create('SPDM.view.modelRelate.modelManage.propertyBasic.PropertyBasicEdit', {
				editMode: 'create'
			});
	...
	openReference: function(params) {
		var me = this,
			editWindow = Ext.create('SPDM.view.modelRelate.modelManage.propertyBasic.PropertyBaseReference', {
				editMode: 'create'
			});
