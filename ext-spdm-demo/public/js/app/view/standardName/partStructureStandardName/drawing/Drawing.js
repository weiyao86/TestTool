Ext.define('SPDM.view.standardName.partStructureStandardName.drawing.Drawing', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.partstructurestandardnamedrawingdrawing',
	requires: ['SPDM.view.standardName.partStructureStandardName.drawing.DrawingRow',
		'SPDM.view.standardName.partStructureStandardName.drawing.Edit',
	...
	buildRow: function(rpt) {
		...
		for (var i = 0; i < rpt.list.length; i++) {
			imgView = Ext.create('SPDM.view.standardName.partStructureStandardName.drawing.DrawingRow');
	...
	updateSketchMap: function(mode, parentForm) {
		...
		var editWin = Ext.create('SPDM.view.standardName.partStructureStandardName.drawing.Edit', {
				editMode: mode
			}).show(),
