Ext.define('SPDM.view.standardName.partStructureStandardName.propertyBasic.PropertyBaseReference', {
	...
	showErrorReport: function(data) {
		var me = this,
			reportWin = Ext.create('SPDM.view.standardName.partStructureStandardName.propertyBasic.PropertyBaseReport').show(),
