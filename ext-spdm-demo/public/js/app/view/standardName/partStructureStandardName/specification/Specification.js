Ext.define('SPDM.view.standardName.partStructureStandardName.specification.Specification', {
	extend: 'Ext.panel.Panel',
	mixins: {
		viewBase: 'SPDM.view.common.class.Base'
	},
	requires: ['SPDM.view.standardName.partStructureStandardName.specification.Grid'],
	...
	openEditWin: function(params, action) {
		var me = this,
			editWin = Ext.create('SPDM.view.standardName.partStructureStandardName.specification.Edit', {
				editMode: action
			});
