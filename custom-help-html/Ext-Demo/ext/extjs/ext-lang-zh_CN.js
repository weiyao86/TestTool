...
Ext.define("Ext.locale.zh_CN.ux.component.filter.AdvancedQuery", {
    override: "Ext.ux.component.filter.AdvancedQuery",
    overflowText: "超出最大添加数量",
    title: "高级查询",
    propertyText: "条件字段",
    operatorText: "操作符",
    valueText: "条件值",
...
Ext.define("Ext.locale.zh_CN.ux.plugin.PagingToolbarResizer", {
	 override: "Ext.ux.plugin.PagingToolbarResizer",
	 pageSizeText: '每页记录数'
});

Ext.define("Ext.locale.zh_CN.ux.plugin.TabCloseMenu", {
	 override: "Ext.ux.plugin.TabCloseMenu",
	 closeTabText:'关闭',
